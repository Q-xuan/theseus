...
mod tests {
    use super::*;
    use pi_protocol::{TurnEnd, TurnEndReason, TurnStart};
    ...
    fn rejects_turn_end_with_open_step() {
        ...
        fence
            ...
            .unwrap();
        fence
            .accept(&EventData::StepStart(pi_protocol::StepStart {
                turn: 1,
                step: 1,
            }))
            .unwrap();
    ...
    fn rejects_step_past_max() {
        ...
        fence
            ...
            .unwrap();
        fence
            .accept(&EventData::StepEnd(pi_protocol::StepEnd {
                turn: 1,
                step: 1,
            }))
            .unwrap();
        let err = fence
            .check(&EventData::StepStart(pi_protocol::StepStart {
                turn: 1,
                step: 2,
            }))
            .unwrap_err();
