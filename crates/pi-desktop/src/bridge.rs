...
//! (same shape as `pi-web`). Not a remote-control surface: bind 127.0.0.1 only.
...
pub async fn serve(addr: SocketAddr, sidecar: Sidecar, rx: Receiver<String>) -> std::io::Result<()> {
...
async fn health() -> impl IntoResponse {
    (
        ...
        r#"{"ok":true,"service":"pi-desktop","bridge":"stdio-sidecar"}"#,
    )
}
